                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        <?php
                            ...
                            $sqlStudentAlreadyExist = "SELECT * FROM teachers WHERE teacherschool = '$headmasterschool'";
                            $statement = $conn->prepare($sqlStudentAlreadyExist);
                            $results = $statement->execute();
                            $rows = $statement->rowCount();
                            ...
                            if($results){
                                foreach($columns as $column){
                                    $id = $column['id'];
                                    $fullname = $column['teacherfirstname'] . $column['teacherlastname'];
                                    $studentclass = $column['teacherclass'];
                                    $studentgender = $column['teachergender'];
