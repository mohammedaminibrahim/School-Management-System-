...
if(empty($password) && empty($password)){
  ...
  $sqlSelectEmail = "SELECT * from headmaster WHERE headmasteremail = '$email'";
  ...
  if($results){    
      if($rows > 0){
          foreach($columns as $column){
            //verify password
            if(password_verify($password, $column['headmasterpassword'])){
              $_SESSION['headmastername'] = $column['headmastername'];
              $_SESSION['headmastercode'] = $column['headmastercode'];
              $_SESSION['headmasterschool'] = $column['headmasterschool'];
          ...
          <div class="flex-grow-1 p-5">
            ...
            <figure class="text-center">
              ...
              <figcaption class="blockquote-footer blockquote-light">
                ...
                Head Teacher Login
                <span class="blockquote-footer-source">Head Teacher | Login</span>
              </figcaption>
            </figure>
            <!-- End Blockquote -->
