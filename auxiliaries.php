...
$sqlNumberofheadmaster= "SELECT * FROM teachers";
...
$sqlNumberOfteachers = "SELECT * FROM teachers";
$statement = $conn->prepare($sqlNumberOfteachers);
$results = $statement->execute();
$NumberOfteachers = $statement->rowCount();
