                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        ...
                        <?php
                          ...
                          $sqlSelectAllHeadTeachers = "SELECT * FROM headmaster";
                          ...
                          foreach($columns as $column){
                            $id = $column['id'];
                            $headmastercode = $column['headmastercode'];
                            $headmastername = $column['headmastername'];
                            $headmasteraddress = $column['headmasteraddress'];
                            $headmasterschool = $column['headmasterschool'];


                            echo "

                            <tr>
                            <td> {$headmastercode}  </td>
                            <td>{$headmastername}</td>
                            <td> {$headmasteraddress}</td>
                            <td> {$headmasterschool}</td>
                          </tr>
                            ";
