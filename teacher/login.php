...
if(empty($email) && empty($password)){
  ...
  $sqlSelectEmail = "SELECT * from teachers WHERE teacheremail = '$email'";
      ...
      if($rows > 0){
          foreach($columns as $column){
            ...
            if($password == $column['password']){
              $_SESSION['teacherfirstname'] = $column['teacherfirstname'];
              $_SESSION['teacherlastname'] = $column['teacherlastname'];
              $_SESSION['teacheremail'] = $column['teacheremail'];
              $_SESSION['teacherclass'] = $column['teacherclass']; 
          ...
          <div class="flex-grow-1 p-5">
            ...
            <figure class="text-center">
              ...
              <figcaption class="blockquote-footer blockquote-light">
                ...
                Teacher Dashboard
                <span class="blockquote-footer-source">Teacher | Login</span>
              </figcaption>
            </figure>
            <!-- End Blockquote -->
